...
export default function IndicesChartPage() {
    // page default data
    const pageName = "Tremorcrypt - Indices Chart";
    ...
    const baseURL = "https://tremorcrypt.com/indexchart";
