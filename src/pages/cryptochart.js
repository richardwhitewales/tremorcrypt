...
export default function CryptoChartPage() {
    // page default data
    const pageName = "Tremorcrypt - Crypto Chart";
    ...
    const baseURL = "https://tremorcrypt.com/cryptochart";
