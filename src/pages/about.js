...
export default function AboutPage() {
    // page default data
    const pageName = "Tremorcrypt - About Us";
    ...
    const baseURL = "https://tremorcrypt.com/about";
                ...
                <div className="container my-5">
                    <div className="row justify-content-center">
                        <div className="col-sm-8">
                            ...
                            <p>
                                Welcome to Tremorcrypt, a leading investment company specializing in cryptocurrency investments.
                            ...
                            <p>
                                At Tremorcrypt, we believe in the power of cryptocurrency and its potential to revolutionize the
                            ...
                            <p>
                                At Tremorcrypt, we prioritize security and confidentiality, implementing the latest encryption
